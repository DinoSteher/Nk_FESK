...
class RegistrationController extends Controller
{
    ...
    protected function postRegister(Request $request)
    {
        ...
        Mail::to($email)->queue(new WelcomeEmail($email, $code, 'Your account has been created!'));
    ...
    public function postResend(Request $request)
    {
        ...
        if (!Activation::completed($user)) {
            ...
            $email = $user->email;
            Mail::to($email)->queue(new WelcomeEmail($email, $code, 'Account Activation Instructions'));
        }
